...
use super::file_opener::{HeaderCache, IndexedBAMOpener};
...
impl IndexedBAMScan {
    ...
    pub fn try_new(base_config: FileScanConfig, header_cache: Arc<HeaderCache>) -> Result<Self> {
...
impl ExecutionPlan for IndexedBAMScan {
    ...
    fn execute(
        ...
        let opener = IndexedBAMOpener::new(Arc::new(config), self.header_cache.clone());
