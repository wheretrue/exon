...
#[derive(Debug, Clone)]
pub struct BAMListingTableConfig {
    inner: ListingTableConfig,

    options: Option<ListingBAMTableOptions>,
}

impl BAMListingTableConfig {
...
#[derive(Debug, Clone)]
/// Options specific to the BAM file format
...
impl ListingBAMTableOptions {
    ...
    pub fn new(file_compression_type: FileCompressionType) -> Self {
        let format = ExonFileType::BAM.get_file_format(file_compression_type);
        let file_extension = ExonFileType::BAM.get_file_extension(file_compression_type);
...
impl ListingBAMTable {
    pub fn try_new(config: BAMListingTableConfig, table_schema: Arc<Schema>) -> Result<Self> {
        Ok(Self {
