...
#[derive(Debug)]
pub struct CRAMRegionFilterUDF {
    signature: Signature,
}

impl Default for CRAMRegionFilterUDF {
    fn default() -> Self {
...
impl ScalarUDFImpl for CRAMRegionFilterUDF {
...
/// Create a scalar UDF for CRAM region filtering.
pub fn register_cram_region_filter_udf(ctx: &SessionContext) {
    let scalar_impl = CRAMRegionFilterUDF::default();
