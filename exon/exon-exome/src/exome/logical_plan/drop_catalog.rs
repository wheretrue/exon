...
const NODE_NAME: &str = "DropExomeCatalog";

#[derive(Clone, Debug, Hash, PartialEq, Eq)]
pub struct DropExomeCatalog {
    pub name: String,
}

impl UserDefinedLogicalNodeCore for DropExomeCatalog {
    fn name(&self) -> &str {
        NODE_NAME
    }
...
impl DfExtensionNode for DropExomeCatalog {
    const NODE_NAME: &'static str = NODE_NAME;
}

impl From<CreateCatalog> for DropExomeCatalog {
